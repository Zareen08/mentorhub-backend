...
export const sendWelcomeEmail = async (to: string, name: string) => {
  ...
  return sendEmail(to, 'Welcome to MentorHub!', html);
};

export const sendBookingConfirmation = async (to: string, name: string, bookingDetails: any) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
  ...
  return sendEmail(to, 'Session Booking Confirmed', html);
};